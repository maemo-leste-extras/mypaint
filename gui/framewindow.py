...
class Window(windowing.Dialog):
    ...
    def _init_ui(self):
        ...
        #Using Maemos colortheme SpinButtons aren't visible at all
        height_entry.modify_bg(gtk.STATE_NORMAL,gtk.gdk.color_parse("#FFFFFF")) #white
        height_entry.modify_bg(gtk.STATE_PRELIGHT,gtk.gdk.color_parse("#FFFFFF"))
        height_entry.modify_bg(gtk.STATE_SELECTED,gtk.gdk.color_parse("#FFFFFF"))
        height_entry.modify_bg(gtk.STATE_ACTIVE,gtk.gdk.color_parse("#FF0000")) #red
        height_entry.modify_bg(gtk.STATE_INSENSITIVE,gtk.gdk.color_parse("#808080")) #dark grey

        width_entry.modify_bg(gtk.STATE_NORMAL,gtk.gdk.color_parse("#FFFFFF"))
        width_entry.modify_bg(gtk.STATE_PRELIGHT,gtk.gdk.color_parse("#FFFFFF"))
        width_entry.modify_bg(gtk.STATE_SELECTED,gtk.gdk.color_parse("#FFFFFF"))
        width_entry.modify_bg(gtk.STATE_ACTIVE,gtk.gdk.color_parse("#FF0000"))
        width_entry.modify_bg(gtk.STATE_INSENSITIVE,gtk.gdk.color_parse("#808080"))
        ...
        top_vbox = self.vbox #Newer gtk uses: self.get_content_area()
